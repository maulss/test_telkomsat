...
//
//     final responseProductsModel = responseProductsModelFromJson(jsonString);

import 'dart:convert';

ResponseProductsModel responseProductsModelFromJson(String str) =>
    ResponseProductsModel.fromJson(json.decode(str));

String responseProductsModelToJson(ResponseProductsModel data) =>
